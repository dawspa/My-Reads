...
* Removed hard coded html from app.js
* Created ListBooks component
* Get all books from API in componentDidMount() lifecycle event
* passed all books in props to ListBooks
* Rendered all books using ListBooks component
* Filtered books to the shelf
